...
SCENES = [
 ('s1', 'The question', [
   ("Some careers deliver projects.",
    "Some careers deliver projects.", 2.50),
 ...
 ('s2', 'The recognition', [
   ("Honorary Fellow (PCI): conferred by the Board of an independent professional body,",
    "Honorary Fellow, P-C-I… conferred by the Board of an independent professional body —", 5.97),
   ("in recognition of distinguished contribution, leadership and service.",
    "in recognition of distinguished contribution, leadership and service.", 10.89),
 ...
 ('s3', 'The Institute', [
   ("The Project Controls Institute is an independent professional body —",
    "The Project Controls Institute is an independent professional body —", 4.05),
   ("a Delaware Non-Stock Corporation —",
    "a Delaware Non-Stock Corporation —", 6.37),
   ("built to give the discipline a shared standard, an independent credential",
    "built to give the discipline a shared standard, an independent credential…", 11.11),
   ("and a professional home for the AI era.",
    "and a professional home for the A-I era.", 14.41),
   ("Its published Body of Knowledge sets thirteen domains and sixty-one knowledge areas.",
    "Its published Body of Knowledge sets thirteen domains and sixty-one knowledge areas.", 19.95),
   ("Its framework is developed with reference to ISO/IEC 17024,",
    "Its framework is developed with reference to I-S-O I-E-C 17024 —", 26.46),
   ("and PCI states plainly that it is not currently accredited by ANAB, IAS or any ISO/IEC 17024 body.",
    "and P-C-I states plainly that it is not currently accredited by A-N-A-B, I-A-S, or any I-S-O I-E-C 17024 body…", 38.72),
   ("What it has is a registry anyone can check.",
    "What it has, is a registry anyone can check."),
 ]),
 ('s4', 'What it is', [
   ("It involves no examination. The record is the evidence, and the Board weighs it.",
    "It involves no examination. The record is the evidence… and the Board weighs it.", 5.93),
   ("It is separate from PCI's examined certifications — PCL-AI, PFL-AI and PML-AI.",
    "It is separate from P-C-I's examined certifications — P-C-L A-I, P-F-L A-I and P-M-L A-I.", 15.51),
   ("Every application is considered individually,",
    "Every application is considered individually…", 18.83),
 ...
 ('s11', 'What it opens', [
   ("If recognised, you may also be given access to the PCI student portal and the Institute's learning resources —",
    "If recognised, you may also be given access to the P-C-I student portal, and the Institute's learning resources —", 6.63),
   ("video lectures, course material and the simulation lab.",
    "video lectures, course material, and the simulation lab.", 10.11),
   ("The same terms may extend to study through Certuvo, PCI's official preparation platform,",
    "The same terms may extend to study through Certuvo, P-C-I's official preparation platform…", 16.16),
 ...
 ('s12', 'Discipline alignment', [
   ("Tell the Board which discipline your contribution aligns to:",
    "Tell the Board which discipline your contribution aligns to —", 5.40),
   ("project controls, project finance or project management.",
    "project controls, project finance, or project management.", 8.91),
 ...
 ('s13', 'Apply', [
   ("If your work has outlasted the projects it was done on, it deserves to be recognised.",
    "If your work has outlasted the projects it was done on… it deserves to be recognised.", 7.17),
   ("Apply for the Board's consideration at pciai.org.",
    "Apply for the Board's consideration — at P-C-I-A-I dot org.", 12.66),
