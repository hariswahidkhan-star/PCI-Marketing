...
SCENES = [
 ('s1', 'The question', [
   ("Some careers deliver projects.",
    "Some careers deliver projects.", 2.31),
 ...
 ('s2', 'The recognition', [
   ("Honorary Fellow (PCI): conferred by the Board of an independent professional body,",
    "Honorary Fellow, P-C-I… conferred by the Board of an independent professional body —", 7.90),
   ("in recognition of distinguished contribution, leadership and service.",
    "in recognition of distinguished contribution, leadership and service.", 13.66),
 ...
 ('s3', 'The Institute', [
   ("The Project Controls Institute is an independent professional body —",
    "The Project Controls Institute is an independent professional body —", 3.78),
   ("a Delaware Non-Stock Corporation —",
    "a Delaware Non-Stock Corporation —", 6.40),
   ("built to give the discipline a shared standard, an independent credential",
    "built to give the discipline a shared standard, an independent credential…", 11.10),
   ("and a professional home for the AI era.",
    "and a professional home for the A-I era.", 15.01),
   ("Its published Body of Knowledge sets thirteen domains and sixty-one knowledge areas.",
    "Its published Body of Knowledge sets thirteen domains and sixty-one knowledge areas.", 20.99),
   ("Its framework is developed with reference to ISO/IEC 17024,",
    "Its framework is developed with reference to I-S-O I-E-C 17024 —", 27.76),
   ("and PCI states plainly that it is not currently accredited by ANAB, IAS or any ISO/IEC 17024 body.",
    "and P-C-I states plainly that it is not currently accredited by A-N-A-B, I-A-S, or any I-S-O I-E-C 17024 body…", 40.02),
   ("What it has is a registry anyone can check.",
    "What it has, is a registry anyone can check."),
 ]),
 ('s4', 'What it is', [
   ("It involves no examination. The record is the evidence, and the Board weighs it.",
    "It involves no examination. The record is the evidence… and the Board weighs it.", 6.18),
   ("It is separate from PCI's examined certifications — PCL-AI, PFL-AI and PML-AI.",
    "It is separate from P-C-I's examined certifications — P-C-L A-I, P-F-L A-I and P-M-L A-I.", 17.50),
   ("Every application is considered individually,",
    "Every application is considered individually…", 20.90),
 ...
 ('s5', 'Who may apply', [
   ("If you have led teams, shaped standards, taught, published or governed —",
    "If you have led teams, shaped standards, taught, published or governed —", 4.98),
 ...
 ('s6', 'Industries', [
   ("From construction and energy to technology, aviation, project finance, government and academia:",
    "From construction and energy… to technology, aviation, project finance, government and academia.", 7.05),
   ("wherever leadership shapes outcomes,",
    "Wherever leadership shapes OUTCOMES,", 10.25),
   ("your contribution counts.",
    "your contribution counts."),
 ]),
 ('s7', 'Eligibility', [
   ("The floor is eight years' experience, three of them at managerial level —",
    "The floor is eight years of professional experience… three of them at managerial level —", 4.97),
   ("leading teams, functions, programmes or budgets.",
    "leading teams, functions, programmes or budgets.", 8.74),
   ("The bar is higher: a demonstrable record of distinguished contribution.",
    "The bar is higher — a demonstrable record of distinguished contribution.", 14.37),
   ("Meeting the criteria does not guarantee recognition.",
    "Meeting the criteria does not guarantee recognition."),
 ]),
 ('s8', 'Your application', [
   ("PCI charges no nomination, assessment or credential fee.",
    "P-C-I charges no nomination, assessment, or credential fee.", 3.94),
   ("Optional extras, such as attending an awards ceremony, are charged separately and play no part in the decision.",
    "Optional extras — such as attending an awards ceremony — are charged separately, and play no part in the decision.", 11.23),
   ("Recognition is awarded solely on merit.",
    "Recognition is awarded solely on merit.", 14.86),
   ("One application: your profile, résumé, career history and evidence,",
    "One application… your profile, résumé, career history and evidence —", 19.96),
   ("reviewed confidentially by the Board.",
    "reviewed confidentially by the Board."),
 ]),
 ('s9', 'Putting yourself forward', [
   ("You need no sponsor to be considered.",
    "You need no sponsor to be considered.", 2.32),
   ("You put your own record forward.",
    "You put your own record forward.", 4.55),
   ("The Board then assesses it against published criteria, on the evidence —",
    "The Board then assesses it against published criteria… on the evidence —", 9.61),
   ("and does so confidentially.",
    "and does so confidentially."),
 ]),
 ('s10', 'The registry', [
   ("Those recognised are entered on PCI's own public registry:",
    "Those recognised are entered on P-C-I's own public registry…", 4.46),
   ("checkable at source by anyone,",
    "checkable at source by anyone —", 6.72),
 ...
 ('s11', 'What it opens', [
   ("If recognised, you may also be given access to the PCI student portal and the Institute's learning resources —",
    "If recognised, you may also be given access to the P-C-I student portal, and the Institute's learning resources —", 6.83),
   ("video lectures, course material and the simulation lab.",
    "video lectures, course material, and the simulation lab.", 10.59),
   ("The same terms may extend to study through Certuvo, PCI's official preparation platform,",
    "The same terms may extend to study through Certuvo, P-C-I's official preparation platform…", 16.85),
 ...
 ('s12', 'Discipline alignment', [
   ("Tell the Board which discipline your contribution aligns to:",
    "Tell the Board which discipline your contribution aligns to —", 4.87),
   ("project controls, project finance or project management.",
    "project controls, project finance, or project management.", 7.82),
 ...
 ('s13', 'Apply', [
   ("If your work has outlasted the projects it was done on, it deserves to be recognised.",
    "If your work has outlasted the projects it was done on… it deserves to be recognised.", 6.20),
   ("Apply for the Board's consideration at pciai.org.",
    "Apply for the Board's consideration — at P-C-I-A-I dot org.", 11.16),
