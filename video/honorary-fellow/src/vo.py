...
SCENES = [
 ...
 ('s3', 'The Institute', [
   ("The Project Controls Institute is an independent professional body —",
    "The Project Controls Institute is an independent professional body —", 4.41),
   ("a Delaware Non-Stock Corporation —",
    "a Delaware Non-Stock Corporation —", 7.24),
   ("built to give the discipline a shared standard, an independent credential",
    "built to give the discipline a shared standard, an independent credential…", 12.28),
   ("and a professional home for the AI era.",
    "and a professional home for the A-I era.", 15.68),
   ("Its published Body of Knowledge sets thirteen domains and sixty-one knowledge areas.",
    "Its published Body of Knowledge sets thirteen domains and sixty-one knowledge areas.", 21.53),
   ("Its framework is developed with reference to ISO/IEC 17024,",
    "Its framework is developed with reference to I-S-O I-E-C 17024 —", 28.36),
   ("and PCI states plainly that it is not currently accredited by ANAB, IAS or any ISO/IEC 17024 body.",
    "and P-C-I states plainly that it is not currently accredited by A-N-A-B, I-A-S, or any I-S-O I-E-C 17024 body…", 40.51),
